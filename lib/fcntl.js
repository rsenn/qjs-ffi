...
const fcntl_ = CFunction({ ptr: dlsym(RTLD_DEFAULT, 'fcntl'), args: [FFIType.i32, FFIType.i32, FFIType.i32], returns: FFIType.i32 });

export function fcntl(fd, cmd, arg = 0) {
  let result = fcntl_(fd, cmd, arg);
  //console.log('fcntl', {fd,cmd,arg,result});
  return result;
}
