import { CFunction, FFIType, dlsym, RTLD_DEFAULT } from 'ffi';
...
function def(name, returns, ...args) {
  return CFunction({ ptr: dlsym(RTLD_DEFAULT, name), args, returns });
}

/* int tcgetattr(int fd, struct termios *termios_p); */
export const tcgetattr = def('tcgetattr', FFIType.i32, FFIType.i32, FFIType.pointer);

/* int tcsetattr(int fd, int optional_actions, struct termios *termios_p); */
export const tcsetattr = def('tcsetattr', FFIType.i32, FFIType.i32, FFIType.i32, FFIType.pointer);

/* int tcflush(int fd, int queue_selector); */
export const tcflush = def('tcflush', FFIType.i32, FFIType.i32, FFIType.i32);

/* int tcdrain(int fd); */
export const tcdrain = def('tcdrain', FFIType.i32, FFIType.i32);

/* int tcflow(int fd, int action); */
export const tcflow = def('tcflow', FFIType.i32, FFIType.i32, FFIType.i32);

/* int tcsendbreak(int fd, int duration); */
export const tcsendbreak = def('tcsendbreak', FFIType.i32, FFIType.i32, FFIType.i32);

/* pid_t tcgetsid(int fd); */
export const tcgetsid = def('tcgetsid', FFIType.i32, FFIType.i32);

/* pid_t tcgetpgrp(int fd); */
export const tcgetpgrp = def('tcgetpgrp', FFIType.i32, FFIType.i32);

/* int tcsetpgrp(int fd, pid_t pgrpid); */
export const tcsetpgrp = def('tcsetpgrp', FFIType.i32, FFIType.i32, FFIType.i32);

/* speed_t cfgetospeed(const struct termios *termios_p); */
export const cfgetospeed = def('cfgetospeed', FFIType.i32, FFIType.pointer);

/* int cfsetospeed(struct termios *termios_p, speed_t speed); */
export const cfsetospeed = def('cfsetospeed', FFIType.i32, FFIType.pointer, FFIType.i32);

/* speed_t cfgetispeed(const struct termios *termios_p); */
export const cfgetispeed = def('cfgetispeed', FFIType.i32, FFIType.pointer);

/* int cfsetispeed(struct termios *termios_p, speed_t speed); */
export const cfsetispeed = def('cfsetispeed', FFIType.i32, FFIType.pointer, FFIType.i32);
