...
import { debug, dlopen, define, dlerror, dlclose, dlsym, errno, call, toString, toArrayBuffer, JSContext, RTLD_LAZY, RTLD_NOW, RTLD_GLOBAL, RTLD_LOCAL, RTLD_NODELETE, RTLD_NOLOAD, RTLD_DEEPBIND, RTLD_DEFAULT, RTLD_NEXT, pointerSize } from 'ffi';
...
export class Socket {
  constructor(family, type, proto = IPPROTO_IP) {
    ...
    this.family = family;
    this.type = typeof type == 'number' ? type : [IPPROTO_UDP, IPPROTO_TCP].indexOf(proto) != -1 ? SOCK_DGRAM : SOCK_STREAM;
