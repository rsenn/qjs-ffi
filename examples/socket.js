...
export class timeval extends ArrayBuffer {
	static arrType = BigUint64Array;
	static numType = n => BigInt(n);
	static numBytes = 2 * 8;

	constructor(sec, usec) {
		super(timeval.numBytes);
...
export class Socket {
	...
	sendto(buf, len, flags = 0, src_addr = null, addrlen = 0) {
		return syscall.sendto(this.fd, buf, len, flags, dest_addr, addrlen);
	}
